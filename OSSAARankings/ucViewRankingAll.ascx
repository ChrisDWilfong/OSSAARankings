<%@ Control Language="VB" AutoEventWireup="false" Inherits="OSSAARankings.ucViewRankingAll" Codebehind="ucViewRankingAll.ascx.vb" %>
            ...
            <asp:TableCell HorizontalAlign="center" VerticalAlign="top">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="40" ItemStyle-HorizontalAlign="Right" HeaderText="School (#1 Rankings)">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="PrevWeek" HeaderText="Prev" Visible="false">
                            <ItemStyle Width="20px" HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="RankDiff" HeaderText="+/-" Visible="false">
                            <ItemStyle Width="20px" HorizontalAlign="Right" />
                        </asp:BoundField>
                    </Columns>
