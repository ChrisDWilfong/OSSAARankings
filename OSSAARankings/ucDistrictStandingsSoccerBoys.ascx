<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucDistrictStandingsSoccerBoys.ascx.vb" Inherits="OSSAARankings.ucDistrictStandingsSoccerBoys" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>  
<asp:Table ID="Table1" runat="server" height="100%">
    <asp:TableRow><asp:TableCell>
        <asp:Label ID="lblHeader" runat="server" Text="<b>OSSAA Boys Soccer District Standings</b>" style="font-family:Century Gothic; font-size: 16px;"></asp:Label>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
    <asp:TableCell>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 1 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 2 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource3" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 3 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource4" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 4 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource5" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 5 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource6" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 6 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource7" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 7 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource8" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
        SelectCommand="SELECT * FROM [ossaauser].[viewDistrictStandingsSoccerBoys] WHERE ([Class] = @SoccerClass) AND District = 8 ORDER BY [Class], District, DistrictWins DESC, DistrictLosses, HeadToHead DESC, DistrictPoints DESC, Wins DESC, SchoolName">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboClass1" Name="SoccerClass" 
            PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
