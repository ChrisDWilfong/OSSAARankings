<%@ Control Language="vb" AutoEventWireup="false" Inherits="OSSAARankings.ucViewScheduleFBBRegionals" Codebehind="ucViewScheduleFBBRegionals.ascx.vb" %>
...
<asp:Table runat="server" style="width:550px" ID="tblFP101">
   ...
   <asp:TableRow HorizontalAlign="Left">
    ...
    <asp:TableRow><asp:TableCell>
        <asp:Image runat="server" src="images/sponsors/regionalSponsor.gif" /><asp:Image runat="server" src="images/sponsors/fallSponsor.gif" /><asp:Image runat="server" src="images/sponsors/playoffSponsor.gif" /><asp:Image runat="server" src="images/sponsors/scoreboardSponsor.gif" />
