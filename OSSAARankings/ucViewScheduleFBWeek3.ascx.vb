...
Partial Class ucViewScheduleFBWeek3
    ...
    Public Function InitializeDataSet(ByVal strClass As String) As String
        ...
        sqlAll = clsSchedules.GetScheduleSportDaySQL(sportGenderKey, gClass, "", "WEEK3", 0)
    ...
    Public Sub RefreshHeader()
        ...
        strSport = "Playoffs Week #3 " & Session("gSportDisplay") & " Schedule"
