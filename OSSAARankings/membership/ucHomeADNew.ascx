<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucHomeADNew.ascx.vb" Inherits="OSSAARankings.ucHomeADNew" %>
<%@ Register src="ucMenuDDNew.ascx" tagname="ucMenu" tagprefix="uc1" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Home Page Athletic Directors</title>
    <style type="text/css">
        .titleHeader
        {
...
<body>
    <table id="tblContent">
        ...
        <br /><br />We hope you find this a useful tool for your school.  It is our mission to provide as much information as possible, as easily as possible.  
