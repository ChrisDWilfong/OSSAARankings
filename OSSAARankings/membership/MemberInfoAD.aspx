<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="SiteAD.Master" CodeBehind="MemberInfoAD.aspx.vb" Inherits="OSSAARankings.MemberInfoAD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table id="tableContent" style="width: 100%;">
        ...
        <tr>
            <td>
                <asp:Label ID="lblSupCell" runat="server" Text="Cell # : " CssClass="label"></asp:Label>
            </td>
            <td>
            ...
            <td>
                <asp:Label ID="lblPasswordInfo1" runat="server" Text="Password : " CssClass="label"></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblPasswordInfo2" runat="server" Text="" CssClass="label"></asp:Label>
            </td>
        ...
        <tr><td>
            &nbsp;</td><td>
            <asp:Button ID="cmdSaveChanges" runat="server" CssClass="button" Text="Save Changes" Font-Bold="true" ForeColor="Red"  BackColor="Yellow" Height="36px" Width="200px" />&nbsp;
            ...
            <asp:Button ID="cmdClearAndSave" runat="server" CssClass="button" 
                Text="Clear Athletic Director Info" CausesValidation="False" 
                    Visible="False"/>
            </td></tr>
    </table>
