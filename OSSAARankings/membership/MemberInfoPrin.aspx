<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="SiteMembership.Master" CodeBehind="MemberInfoPrin.aspx.vb" Inherits="OSSAARankings.MemberInfoPrin" %>
   ...
   <table id="tableContent" style="width: 100%;">
        ...
        <tr><td>
            ...
            <asp:Button ID="cmdClearAndSave" runat="server" CssClass="button" 
                Text="Clear Principal Info" CausesValidation="False" 
                    Visible="False"/>
            </td></tr>
    </table>
