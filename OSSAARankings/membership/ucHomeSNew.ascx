<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucHomeSNew.ascx.vb" Inherits="OSSAARankings.ucHomeSNew" %>
<%@ Register src="ucMenuDDNew.ascx" tagname="ucMenu" tagprefix="uc1" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Home Page Superintendents</title>
    <style type="text/css">
        .titleHeader
        {
...
<body>
    <table id="tblContent">
        ...
        <tr><td><hr /></td></tr>
        <tr><td><asp:Label ID="lblVotingDelegate" runat="server" Text="Your current Voting Delegate Is : " CssClass="content" Font-Size="16px" Font-Bold="true" ForeColor="Red"></asp:Label></td></tr>
        <%= Session("membersLinksSUP")%>
