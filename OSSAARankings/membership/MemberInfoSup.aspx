<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="SiteMembership.Master" CodeBehind="MemberInfoSup.aspx.vb" Inherits="OSSAARankings.MemberInfoSup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table id="tableContent" style="width: 100%;">
        ...
        <tr><td>
            &nbsp;</td><td>
            <asp:Button ID="cmdSaveChanges" runat="server" CssClass="button" Text="Save Changes" Font-Bold="true" BackColor="Yellow" ForeColor="Red" Height="36px" Width="200px" />&nbsp;
            ...
            <asp:Button ID="cmdClearAndSave" runat="server" CssClass="button" 
                Text="Clear Superintendent Info" CausesValidation="False" 
                    Visible="False"/>
            </td></tr>
    </table>
    <table id="tableFooter" style="width: 100%;">
        ...
        <tr>
        <td>
            <asp:Label ID="lblCopyright" runat="server" Font-Size="X-Small" Text="Copyright © 2014 OSSAA. All rights reserved.  "></asp:Label><a href="http://www.ossaa.com" target="_blank"><span style="font-family: Century Gothic; Font-Size:X-Small;">OSSAA Home Page</a>
        </td>
        </tr>
        <tr>
        <td>
