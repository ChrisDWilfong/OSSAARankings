<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="SiteMembership.Master" CodeBehind="MemberInfoSchool.aspx.vb" Inherits="OSSAARankings.MemberInfoSchool" %>
    ...
    <table id="tableContent" style="width: 100%;">
        ...
        <tr><td>
            ...
            <asp:Button ID="cmdSaveChanges" runat="server" CssClass="button" 
                ...
                Text="Cancel Changes" CausesValidation="False" Width="164px" />
            </td></tr>
        </table>
