...
Partial Class ucViewRankingAll5
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If rankGender = "5d" Then
            sportGenderKey = "WrestlingDual"
            'GridView1.Columns(1).HeaderText = "School (** = District Champs)"
        Else
        ...
        Else
            ...
            For x = 0 To ds1.Tables(0).Rows.Count - 1
                ...
                If sid.Contains("WrestlingDual") Then
                    sql2 = "SELECT TOP " & intNumberOfRankings & " * FROM ossaauser.viewWrestlingDualLast5WeeksOfRankings WHERE (sportID = '" & ds1.Tables(0).Rows(x).Item("sportID") & "') "
                Else
