<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AverageGolfScoresBoys.aspx.vb" Inherits="OSSAARankings.AverageGolfScoresBoys" %>
...
<body>
    ...
    <asp:Label runat="server" Text="Boys Golf Scores" Font-Names="Arial" Font-Size="Large" ForeColor="Maroon"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AverageGolfScoresGirls.aspx" Font-Names="Arial" Font-Size="Small">Go to Girls Scores...</asp:HyperLink><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [viewAverageGolfScoreBoys] WHERE avgGolfScore > 0 AND strClass = @Class ORDER BY avgGolfScore, SchoolName">
        <SelectParameters>
