Partial Class StateScoreboardDualState
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblHeader.Text = "20" & Session("gYear") & " OSSAA Dual State Wrestling Championships Scoreboard"
    ...
    Public Sub UpdateGames()
        ...
        ' Refresh all...
        ClearVariables()
        lblBoys3A.Text = UpdateClass("WrestlingDual3A")

        ClearVariables()
        lblBoys4A.Text = UpdateClass("WrestlingDual4A")

        ClearVariables()
        lblBoys5A.Text = UpdateClass("WrestlingDual5A")

        ClearVariables()
        lblBoys6A.Text = UpdateClass("WrestlingDual6A")
