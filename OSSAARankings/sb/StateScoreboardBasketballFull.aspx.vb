Public Class StateScoreboardBasketballFull
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ' Header Updates...
        lblClassAHeader.Text = "CLASS A STATE TOURNAMENT : March 2-4, 2017"
        lblClassBHeader.Text = "CLASS B STATE TOURNAMENT : March 2-4, 2017"
        lblClass2AHeader.Text = "CLASS 2A STATE TOURNAMENT : March 9-11, 2017"
        lblClass3AHeader.Text = "CLASS 3A STATE TOURNAMENT : March 9-11, 2017"
        lblClass4AHeader.Text = "CLASS 4A STATE TOURNAMENT : March 9-11, 2017"
        lblClass5AHeader.Text = "CLASS 5A STATE TOURNAMENT : March 9-11, 2017"
        lblClass6AHeader.Text = "CLASS 6A STATE TOURNAMENT : March 9-11, 2017"
    ...
    Public Sub UpdateGames()
        ...
        If ConfigurationManager.AppSettings("BKScoreboardA") = 1 Then
            ClearVariables()
        ...
        If ConfigurationManager.AppSettings("BKScoreboardB") = 1 Then
            ClearVariables()
        ...
        If ConfigurationManager.AppSettings("BKScoreboard2A") = 1 Then
            ClearVariables()
        ...
        If ConfigurationManager.AppSettings("BKScoreboard3A") = 1 Then
            ClearVariables()
        ...
        If ConfigurationManager.AppSettings("BKScoreboard4A") = 1 Then
            ClearVariables()
        ...
        If ConfigurationManager.AppSettings("BKScoreboard5A") = 1 Then
            ClearVariables()
        ...
        If ConfigurationManager.AppSettings("BKScoreboard6A") = 1 Then
            ClearVariables()
    ...
    Public Function UpdateClass(strSportKey As String) As String
        ...
        If ds Is Nothing Then
            ...
            If strSportKey.Contains("Boys") Then
                strResult += "<tr><td style='text-align:Center;'><img src='../images/BasketballScoreboardBOYS.gif'></td></tr>"
            Else
                strResult += "<tr><td style='text-align:Center;'><img src='../images/BasketballScoreboardGirls.gif'></td></tr>"
            End If
            strResult += "</table>"
            ...
            For x = 0 To ds.Tables(0).Rows.Count - 1
                ...
                Else
                    ...
                    If intGame = 1 Then
                        ...
                        If strSportKey.Contains("Boys") Then
                            strResult += "<tr><td style='text-align:Center;'><img src='../images/BasketballScoreboardBOYS.gif' width='300px'></td></tr>"
                        Else
                            strResult += "<tr><td style='text-align:Center;'><img src='../images/BasketballScoreboardGirls.gif' width='300px'></td></tr>"
                        End If
                        strResult += "<tr><td style='text-align:Center;'><img src='../images/BasketballScoreboardQ.gif' width='250px'></td></tr>"

                        If intGameNo = 1101 Or intGameNo = 1201 Then
                            strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), strSchoolName1a, strSchoolName1b) & "</td></tr>"
                        ElseIf intGameNo = 1102 Or intGameNo = 1202 Then
                            strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), strSchoolName2a, strSchoolName2b) & "</td></tr>"
                        ElseIf intGameNo = 1103 Or intGameNo = 1203 Then
                            strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), strSchoolName3a, strSchoolName3b) & "</td></tr>"
                        ElseIf intGameNo = 1104 Or intGameNo = 1204 Then
                            strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), strSchoolName4a, strSchoolName4b) & "</td></tr>"
                        End If
                    ...
                    'End If
                    If intGame = 5 Then
                        strResult += "<tr><td style='text-align:Center;font-family:Oswald;'><img src='../images/BasketballScoreboardS.gif' width='250px'></td></tr>"
                    End If
                    ...
                    If intGame = 5 Or intGame = 6 Then
                        ...
                        If intGameNo = 1105 Or intGameNo = 1205 Then
                            If intScore1a = 0 And intScore1b = 0 And intScore2a = 0 And intScore2b = 0 Then
                                strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), "", "") & "</td></tr>"
                            ElseIf intScore1a > 0 And intScore1b > 0 And intScore2a > 0 And intScore2b > 0 Then
                                strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), "", "") & "</td></tr>"
                            ElseIf intScore1a > 0 Then
                                strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:12px;'>" & ReturnLine(ds.Tables(0).Rows(x), strSchoolName2a, strSchoolName2b) & "</td></tr>"
                    ...
                    If intGame = 7 Then
                        ...
                        If strSportKey.Contains("6A") Or strSportKey.Contains("5A") Then
                            strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:14px;'><a href='http://www.ossaa.net/docs/2016-17/HomeColumn1/MF_2016-17_GriffinHoops.pdf?id=0' target='_blank'>Watch on KSBI (OKC) - KQCW (Tulsa)</i></td></tr>"
                        ElseIf strSportKey.Contains("2A") Or strSportKey.Contains("3A") Or strSportKey.Contains("4A") Then
                            strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:14px;'><a href='http://www.nfhsnetwork.com/?id=547' target='_blank'>Watch NFHSNETWORK.COM Pay-Per-View</i></td></tr>"
                        End If
                        strResult += "<tr><td style='text-align:Center;font-family:Oswald;font-size:14px;'>" & ReturnLine(ds.Tables(0).Rows(x), "", "") & "</td></tr>"
                        strResult += "</table>"
                    End If
                End If
            Next
