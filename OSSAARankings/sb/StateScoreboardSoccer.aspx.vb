Public Class StateScoreboardSoccer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblHeader.Text = "20" & Session("gYear") & " OSSAA SOCCER State Championships Scoreboard"

        ' Header Updates...
        lblClass4AGirlsHeader.Text = "Class 4A Girls Soccer State Playoffs (May 6th / 10th / 14th)"
        lblClass4ABoysHeader.Text = "Class 4A Boys Soccer State Playoffs (May 6th / 10th / 14th)"
        lblClass5AGirlsHeader.Text = "Class 5A Girls Soccer State Playoffs (May 6th / 10th / 14th)"
        lblClass5ABoysHeader.Text = "Class 5A Boys Soccer State Playoffs (May 6th / 10th / 13th)"
        lblClass6AGirlsHeader.Text = "Class 6A Girls Soccer State Playoffs (May 6th / 10th / 14th)"
        lblClass6ABoysHeader.Text = "Class 6A Boys Soccer State Playoffs (May 6th / 10th / 13th)"
    ...
    Public Sub UpdateGames()
        ...
        ' Refresh all...
        ClearVariables()
        lblBoys6A.Text = UpdateClass("SoccerBoys6A")
        ClearVariables()
        lblGirls6A.Text = UpdateClass("SoccerGirls6A")
        ClearVariables()
        lblBoys5A.Text = UpdateClass("SoccerBoys5A")
        ClearVariables()
        lblGirls5A.Text = UpdateClass("SoccerGirls5A")
        ClearVariables()
        lblBoys4A.Text = UpdateClass("SoccerBoys4A")
        ClearVariables()
        lblGirls4A.Text = UpdateClass("SoccerGirls4A")
