<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StateScoreboardDualState.aspx.vb" Inherits="OSSAARankings.StateScoreboardDualState" ClientTarget="uplevel"  %>
...
<div style="vertical-align:top;">
                    <asp:Table runat="server" Width="890px">
                        ...
                        <asp:TableCell>
                            <asp:Label ID="lblHeader" runat="server" CssClass="labelHeaderMain" Font-Names="Oswald" Text="2017 OSSAA Dual State Wrestling Scoreboard" Height="34px" Font-Size="22px" Width="100%" BorderColor="Black" BorderWidth="1px"></asp:Label>
                        </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell>
