<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StateScoreboardBaseball.aspx.vb" Inherits="OSSAARankings.StateScoreboardBaseball" ClientTarget="uplevel"  %>
...
<head runat="server">
    <title>OSSAA Baseball State Tournament Scoreboard</title>
</head>
<body>
    ...
    <asp:table width="900px" Height="360px" runat="server">
        <asp:TableRow Width="100%" VerticalAlign="Bottom">
            <asp:TableCell>
                <asp:Label ID="lblHeader" runat="server" CssClass="labelHeaderMain" Text="2016 OSSAA Baseball State Championships Scoreboard" Height="30px" Font-Size="22px" Width="100%" BorderColor="Black" BorderWidth="1px"></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        ...
        <ig:WebTab ID="WebTab1" runat="server" width="890px" Height="315px" DisplayMode="SingleRow" SelectedIndex="0" StyleSetName="Windows7">
            <Tabs>
                <ig:ContentTabItem runat="server" Text="<span style='font-size:18px;font-weight:bold;'>Class 6A</span>" EnableAjax="True" TabSize="100px" Enabled="True">
                    <Template>
                ...
                <ig:ContentTabItem runat="server" Text="<span style='font-size:18px;font-weight:bold;'>Class 5A</span>" EnableAjax="True" TabSize="100px" Enabled="True">
                    <Template>
                ...
                <ig:ContentTabItem runat="server" Text="<span style='font-size:18px;font-weight:bold;'>Class 4A</span>" EnableAjax="True" TabSize="100px" Enabled="True">
                    <Template>
                ...
                <ig:ContentTabItem runat="server" Text="<span style='font-size:18px;font-weight:bold;'>Class 3A</span>" EnableAjax="True" TabSize="100px" Enabled="True">
                    <Template>
                ...
                <ig:ContentTabItem runat="server" Text="<span style='font-size:18px;font-weight:bold;'>Class 2A</span>" EnableAjax="True" TabSize="100px" Enabled="True">
                    <Template>
                ...
                <ig:ContentTabItem runat="server" Text="<span style='font-size:18px;font-weight:bold;'>Class B</span>" EnableAjax="True" TabSize="100px">
                    <Template>
                        <asp:table ID="Table7" width="100%" runat="server">
                            <asp:TableRow VerticalAlign="Top">
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                                    <asp:Label ID="lblClassBHeader" runat="server" CssClass="labelHeaderMainGray" Width="100%" Height="30px"></asp:Label>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow VerticalAlign="Top">
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center" VerticalAlign="Top">
                                    <asp:Table ID="Table8" runat="server">
                                        <asp:TableRow HorizontalAlign="Center" VerticalAlign="Top">
                                            <asp:TableCell HorizontalAlign="Center" style="padding-right:10px;"><asp:Label CssClass="labelSemi" ID="lblBoysB" runat="server" Text=""></asp:Label>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                    </asp:Table>
                                </asp:TableCell>
