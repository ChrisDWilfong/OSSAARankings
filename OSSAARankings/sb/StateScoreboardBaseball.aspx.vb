Public Class StateScoreboardBaseball
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblHeader.Text = "20" & Session("gYear") & " OSSAA Baseball State Championships Scoreboard"

        ' Header Updates...
        lblClassBHeader.Text = "Class B State Tournament @ May 5-7 @ Palmer Field/Bricktown"
        lblClassAHeader.Text = "Class A State Tournament @ May 5-7 @ Palmer Field/Bricktown"
        lblClass2AHeader.Text = "Class 2A State Tournament @ May 12-14 @ Shawnee HS"
        lblClass3AHeader.Text = "Class 3A State Tournament @ May 12-14 @ Edmond Memorial"
        lblClass4AHeader.Text = "Class 4A State Tournament @ May 12-14 @ Edmond Santa Fe"
        lblClass5AHeader.Text = "Class 5A State Tournament @ May 12-14 @ Yukon HS"
        lblClass6AHeader.Text = "Class 6A State Tournament @ May 12-14 @ OU/Choctaw/Bricktown"
    ...
    Public Sub UpdateGames()
        ...
        ' Refresh all...
        ClearVariables()
        lblBoysB.Text = UpdateClass("BaseballB")
        ClearVariables()
        lblBoysA.Text = UpdateClass("BaseballA")
        ClearVariables()
        lblBoys2A.Text = UpdateClass("Baseball2A")
        ClearVariables()
        lblBoys3A.Text = UpdateClass("Baseball3A")
        ClearVariables()
        lblBoys4A.Text = UpdateClass("Baseball4A")
        ClearVariables()
        lblBoys5A.Text = UpdateClass("Baseball5A")
        ClearVariables()
        lblBoys6A.Text = UpdateClass("Baseball6A")
