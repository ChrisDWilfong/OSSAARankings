Public Class _Default
    ...
    ' NOTE : Swap these when Playoffs are being shown...
    'Public MenuIndexRankings As Integer = 0
    'Public MenuIndexSchedulesPlayoffs As Integer = 1
    'Public MenuIndexSchedulesByClass As Integer = 2
    'Public MenuIndexSchedulesByDate As Integer = 3
    'Public MenuIndexDistrictStandings As Integer = 4
    'Public MenuIndexSchools As Integer = 5
    'Public MenuIndexCoaches As Integer = 6
    'Public MenuIndexAthleticDirectors As Integer = 7
    'Public MenuIndexRankings14 = 8
    'Public MenuIndexSchedulesByClass As Integer = 9
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		objHL01.NavigateUrl = "https://cicad.us/2WbgVAN"
		objHL01.ImageUrl = "~/images/sponsors/Ad_Army_450Banner.jpg"
		objHL02.NavigateUrl = "https://oerb.com?utm_source=displayspon&utm_medium=display&utm_campaign=EnergizingOurEconomy-Building-p"
		objHL02.ImageUrl = "~/images/sponsors/OKOilAndNaturalGasBanner1_450.jpg"
		RadRotator1.Width = 451
        RadRotator1.Height = 55
        RadRotator1.ItemWidth = 451
        RadRotator1.ItemHeight = 55
        ...
        Else
            ...
            strControlName1 = "ucViewHomePage.ascx"
        ...
        Select Case Session("sel")
			...
			Case "schedulesClass", "schedulesClass14", "schedulesClass15", "schedulesClass16", "schedulesClass17", "schedulesClass18", "schedulesClass19"
				Session("gSportGenderKey") = Request.QueryString("spGK")
                ...
                If Session("gYear") = clsFunctions.GetCurrentYear Then
                    ...
                    LeftAccordion.SelectedIndex = MenuIndexSchedulesByClass
                    ' CDW added 6/2019...
                ElseIf Session("gYear") = 18 Then
                    strControlName = "ucViewScheduleClass.ascx"
                    LeftAccordion.SelectedIndex = MenuIndexSchedulesByClass18
                ElseIf Session("gYear") = 17 Then
                    strControlName = "ucViewScheduleClass.ascx"
                    LeftAccordion.SelectedIndex = MenuIndexSchedulesByClass17
                ElseIf Session("gYear") = 16 Then
                    strControlName = "ucViewScheduleClass.ascx"
                    LeftAccordion.SelectedIndex = MenuIndexSchedulesByClass16
                ElseIf Session("gYear") = 15 Then
            ...
            Case Else
                ...
                Session("gSport") = Request.QueryString("sp")
                Session("gSportGenderKey") = Request.QueryString("spGK")
                strControlName = "ucViewHomePage.ascx"
                LeftAccordion.SelectedIndex = MenuIndexRankings
        End Select
