<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EntryFormsEdit1.ascx.vb" Inherits="OSSAARankings.EntryFormsEdit1" %>
...
<asp:Panel ID="PanelFormsEdit" runat="server" CssClass="panelHome">
    ...
    <asp:UpdatePanel ID="UpdatePanelEditForms" runat="server" UpdateMode="Always">
        ...
        <asp:Table runat="server" ID="tblCheerleadingGameDay" visible="false">
            ...
            <asp:TableRow>
                <asp:TableCell style="width:120px;">
                    <asp:Label ID="Label154" runat="server" Text="EMAIL ADDRESS?&nbsp;&nbsp;" Width="140px" Font-Bold="True"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:TextBox ID="TextBoxSubmittedByCheerleadingGameDayEmail" runat="server" Width="225px" Text="Enter your email"></asp:TextBox>
                    <asp:Label ID="Label155" runat="server" Text=" *" Font-Bold="true" Font-Size="18px" ForeColor="Red"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
             <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
