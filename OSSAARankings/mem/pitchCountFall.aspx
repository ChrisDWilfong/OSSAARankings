<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pitchCountFall.aspx.vb" Inherits="OSSAARankings.pitchCountFall" %>
...
<body style="background-color:LightGray;">
    ...
    <div style="font-family:Verdana;font-size:small;">
        <asp:Label ID="lblHeader" runat="server" Text="FALL BASEBALL PITCH COUNT - OSSAARankings.com" Font-Bold="true" ForeColor="Maroon" Font-Size="X-Large"></asp:Label><br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [strDisplay], [teamID] FROM [viewFallBaseballTeams] ORDER BY [SchoolName]">
    </asp:SqlDataSource>
</body>
</html>
