        ...
        Select Case strSport
            ...
            Case "CheerleadingGD"           ' CDW added 7/24/2019...
                ...
                ElseIf (TextBoxSubmittedByCheerleadingGameDay.Text = "" Or TextBoxSubmittedByCheerleadingGameDay.Text = "Enter your name") Then
                    strResult = "You must enter SUBMITTED BY."
                ElseIf (TextBoxSubmittedByCheerleadingGameDayEmail.Text = "" Or TextBoxSubmittedByCheerleadingGameDayEmail.Text = "Enter your email") Then
                    strResult = "You must enter EMAIL ADDRESS."
                Else
                    strResult = "OK"
                End If
...
#Region "Save Commands"
    ...
    Private Sub cmdSaveCheerleadingGameDay_Click(sender As Object, e As EventArgs) Handles cmdSaveCheerleadingGameDay.Click
        ...
        If strResult = "OK" Then
            ...
            Else
                ' Write the No...
                strSQL = "UPDATE prodParticipation SET EntryFormYN = 'N', strSubmittedBy = '" & clsFunctions.StringValidate(TextBoxSubmittedByCheerleadingGameDay.Text) & "', strEmail = '" & clsFunctions.StringValidate(TextBoxSubmittedByCheerleadingGameDayEmail.Text) & "' WHERE Id = " & Session("selectedID")
                SqlHelper.ExecuteNonQuery(SqlHelper.SQLConnectionOSSAAServer, CommandType.Text, strSQL)
            ...
            If strOK = "OK" Then
                ...
                strSQL += "strEmail = '" & clsFunctions.StringValidate(TextBoxSubmittedByCheerleadingGameDayEmail.Text) & "' "
