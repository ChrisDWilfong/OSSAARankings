<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucScheduleListSmall.ascx.vb" Inherits="OSSAARankings.ucScheduleListSmall" %>
...
<asp:TableRow HorizontalAlign="Center"><asp:TableCell>
    <asp:HyperLink ID="hlPrint" runat="server" Font-Names="Verdana" Font-Size="8pt" NavigateUrl="PrintScheduleSmall.aspx?sel=ts&t=0" Target="_blank">Print Version</asp:HyperLink>
</asp:TableCell></asp:TableRow>
<asp:TableRow><asp:TableCell>
    <asp:Label ID="lblTeamInfo" runat="server" CssClass="headerSmall" Height="24px" Text="Team (Class)" Width="100%"></asp:Label>
</asp:TableCell></asp:TableRow>
<asp:TableRow>
<asp:TableCell>
<asp:GridView ID="GridView1" runat="server" CellPadding="4" Height="209px" Width="100%" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Opposing Team" HeaderText="Opposing Team" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HtmlEncodeFormatString="false" HtmlEncode="false" >    
        </asp:BoundField>
    </Columns>
