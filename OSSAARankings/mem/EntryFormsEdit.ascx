<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EntryFormsEdit.ascx.vb" Inherits="OSSAARankings.EntryFormsEdit"  %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Panel ID="PanelFormsEdit" runat="server" CssClass="panelHome">

    <asp:UpdatePanel ID="UpdatePanelFE112" runat="server" UpdateMode="Conditional">
        <ContentTemplate>

        <%-- **************************************************************** BASEBALL --%>
        <asp:Table runat="server" ID="tblBaseball" visible="false" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Font-Size="X-Large"><strong>2017-18 BASEBALL ENTRY FORM</strong></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageBaseballHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label7" runat="server" Text="PARTICIPATING (SPRING)? <span style='color:Red;'>(DUE : FEBURARY 8, 2018)</span>" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label33" runat="server" Text="PARTICIPATING (FALL)? <span style='color:Red;'>(DUE : AUGUST 11, 2017)</span>" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveBaseball" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelBaseball" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
        ...
        <asp:Table runat="server" ID="tblBasketball" visible="false" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Font-Size="X-Large"><strong>2017-18 BASKETBALL FACILITY FORM</strong></asp:TableCell>
            </asp:TableRow>

            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageBasketballHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label27" runat="server" Text="Are you interested in hosting a post season basketball tournament for the 2017-18 season?" Font-Bold="True"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label ID="Label1361" runat="server" Text="<strong>Dimensions of our playing court are ?</strong>"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveBasketball" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelBasketball" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
        ...
        <asp:Table runat="server" ID="tblCheerleading" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="<strong>2017 CHEERLEADING ENTRY FORM</strong>" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageCheerleadingHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="Label1331" Font-Names="Segoe UI, Arial" Font-Size="Large" ForeColor="Red" Font-Bold="true" Text="DUE : AUGUST 25, 2017"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label52" runat="server" Text="PARTICIPATING?" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label34" runat="server" Text="CO-ED SQUAD?" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width:120px;">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="TextBoxSubmittedByCheerleading" runat="server" Width="225px" Text="Enter your name" Font-Bold="True"></asp:TextBox>
                    <asp:Label ID="Label26" runat="server" Text=" *" Font-Bold="true" Font-Size="18px" ForeColor="Red"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveCheerleading" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelCheerleading" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;
        ...
        <asp:Table runat="server" ID="tblCrossCountryBoys" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="2017 CROSS COUNTRY BOYS ENTRY FORM" Font-Size="X-Large" Font-Bold="true"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageCrossCountryBoysHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="Label13322" Font-Names="Segoe UI, Arial" Font-Size="Large" ForeColor="Red" Font-Bold="true" Text="DUE : NO LATER THAN OCTOBER 2, 2017 FOR CLASSES 2A, 3A and 4A<br>DUE NO LATER THAN OCTOBER 9, 2017 FOR CLASSES 5A-6A"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width:75px;">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label ID="Label21" runat="server" Text="SUBMITTED BY?&nbsp;"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
            ...
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveCrossCountryBoys" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelCrossCountryBoys" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
                <asp:Label runat="server" ID="lblMessageCrossCountryBoys" ForeColor="Red" Font-Names="Anton, Segoe UI" Font-Size="Large" Text="Enter all Participants then <click> SAVE CHANGES." Font-Bold="True"></asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table runat="server" ID="tblCrossCountryGirls" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="2017 CROSS COUNTRY GIRLS ENTRY FORM" Font-Bold="true" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageCrossCountryGirlsHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="lblCrossCountryGirlsHeader" Font-Names="Segoe UI, Arial" Font-Size="Large" ForeColor="Red" Font-Bold="true" Text="DUE : DUE NO LATER THAN OCTOBER 2, 2017 FOR CLASSES 2A, 3A and 4A<br>DUE NO LATER THAN OCTOBER 9, 2017 FOR CLASSES 5A-6A"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width:75px;">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="TextBoxSubmittedByCrossCountryGirls" runat="server" Width="225px" Text="Enter your name" Font-Bold="True" ></asp:TextBox>
                    <asp:Label ID="Label50" runat="server" Text=" *" Font-Bold="true" Font-Size="18px" ForeColor="Red"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveCrossCountryGirls" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelCrossCountryGirls" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
                <asp:Label runat="server" ID="lblMessageCrossCountryGirls" ForeColor="Red" Font-Names="Anton, Segoe UI" Font-Size="Large" Text="Enter all Participants then <click> SAVE CHANGES." Font-Bold="True"></asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table runat="server" ID="tblGolfBoys" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="2018 GOLF BOYS ENTRY FORM" Font-Bold="true" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageGolfBoysHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="lblGolfBoysHeader" Font-Names="Segoe UI, Arial" Font-Size="Large" ForeColor="Red" Font-Bold="True" Text="DUE : APRIL 2, 2018"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width:75px;">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:Label ID="Label97" runat="server" Text=" *" Font-Bold="true" Font-Size="18px" ForeColor="Red"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
            ...
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveGolfBoys" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelGolfBoys" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
                <asp:Label runat="server" ID="lblMessageGolfBoys" ForeColor="Red" Font-Names="Anton, Segoe UI" Font-Size="Large" Text="Enter all Golfers then <click> SAVE CHANGES." Font-Bold="True"></asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table runat="server" ID="tblGolfGirls" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="2018 GOLF GIRLS ENTRY FORM" Font-Bold="true" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageGolfGirlsHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="lblGolfGirlsHeader" Font-Names="Segoe UI, Arial" Font-Size="Medium" ForeColor="Red" Font-Bold="True" Text="DUE : APRIL 2, 2018"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width:75px;">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    ...
                    <asp:Label ID="Label106" runat="server" Text=" *" Font-Bold="true" Font-Size="18px" ForeColor="Red"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
            ...
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveGolfGirls" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelGolfGirls" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
                <asp:Label runat="server" ID="lblMessageGolfGirls" ForeColor="Red" Font-Names="Anton, Segoe UI" Font-Size="Large" Text="Enter all Participants then <click> SAVE CHANGES." Font-Bold="True"></asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table runat="server" ID="tblFPSoftball" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="2017 FAST PITCH SOFTBALL ENTRY FORM" Font-Bold="true" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageFastPitchHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="lblDueDateFastPitch" Font-Names="Segoe UI, Arial" Font-Size="Large" ForeColor="Red" Font-Bold="True" Text="DUE : AUGUST 25, 2017"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
        		    &nbsp;&nbsp;<asp:Label ID="Label1b" runat="server" Text="LF : " Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="TextBoxFPSoftball1" runat="server" Width="60px"></asp:TextBox>&nbsp;&nbsp;		    
		            <asp:Label ID="Label1c" runat="server" Text="CF : " Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="TextBoxFPSoftball2" runat="server" Width="60px"></asp:TextBox>&nbsp;&nbsp;
		            <asp:Label ID="Label1d" runat="server" Text="RF : " Font-Bold="True"></asp:Label>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label71" runat="server" Text="How far is back stop from home plate?" Font-Bold="True"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center">
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveFPSoftball" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelFPSoftball" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>
        ...
        <asp:Table runat="server" ID="tblSPSoftball" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="<strong>2018 SLOW-PITCH SOFTBALL ENTRY FORM</strong>" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageSlowPitchHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="lblDueDateSlowPitch" Font-Names="Segoe UI, Arial" Font-Size="Large" Font-Bold="True" ForeColor="Red" Text="DUE : JANUARY 29, 2018"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center">
                    <telerik:RadDropDownList ID="RadDropDownListSPSoftball2" runat="server" Width="60px" >
                        <Items>
                            <telerik:DropDownListItem Text="Select..." Value="-" />
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
        		    &nbsp;&nbsp;<asp:Label ID="Label117" runat="server" Text="LF : " Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="TextBoxSPSoftball1" runat="server" Width="60px"></asp:TextBox>&nbsp;&nbsp;		    
		            <asp:Label ID="Label118" runat="server" Text="CF : " Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="TextBoxSPSoftball2" runat="server" Width="60px"></asp:TextBox>&nbsp;&nbsp;
		            <asp:Label ID="Label119" runat="server" Text="RF : " Font-Bold="True"></asp:Label>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label121" runat="server" Text="How far is back stop from home plate?" Font-Bold="True"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center">
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveSPSoftball" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelSPSoftball" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>
        ...
        <asp:Table runat="server" ID="tblVolleyball" visible="false">
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Text="<strong>2017 VOLLEYBALL ENTRY FORM</strong>" Font-Size="X-Large"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageVolleyballHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <asp:Label runat="server" ID="lblVolleyballHeader" Font-Names="Segoe UI, Arial" Font-Size="Large" ForeColor="Red" Font-Bold="True" Text="DUE : AUGUST 14, 2017"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell style="width:75px;">
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveVolleyball" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelVolleyball" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>
        ...
        <asp:Table runat="server" ID="tblSwimmingBoys" visible="false" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Font-Size="X-Large"><strong>2017-18 BOYS SWIMMING ENTRY FORM</strong></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageSwimmingBoysHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label78" runat="server" Text="PARTICIPATING : BOYS SWIMMING? <span style='color:Red;'>(DUE : October 20, 2017)</span>" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveSwimmingBoys" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelSwimmingBoys" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
        ...
        <asp:Table runat="server" ID="tblSwimmingGirls" visible="false" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Font-Size="X-Large"><strong>2017-18 GIRLS SWIMMING ENTRY FORM</strong></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageSwimmingGirlsHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label28" runat="server" Text="PARTICIPATING : GIRLS SWIMMING? <span style='color:Red;'>(DUE : October 20, 2017)</span>" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveSwimmingGirls" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelSwimmingGirls" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
        ...
        <asp:Table runat="server" ID="tblTennisBoys" visible="false" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Font-Size="X-Large"><strong>2018 BOYS TENNIS ENTRY FORM</strong></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageTennisBoysHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label83" runat="server" Text="PARTICIPATING : BOYS TENNIS? <span style='color:Red;'>(DUE : April 4, 2018)</span>" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2"><hr /></asp:TableCell></asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveTennisBoys" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelTennisBoys" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
        ...
        <asp:Table runat="server" ID="tblTennisGirls" visible="false" >
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" Font-Size="X-Large"><strong>2018 GIRLS TENNIS ENTRY FORM</strong></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2"><asp:Label runat="server" ID="lblMessageTennisGirlsHeader" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label84" runat="server" Text="PARTICIPATING : GIRLS TENNIS? <span style='color:Red;'>(DUE : April 4, 2018)</span>" Font-Bold="true" Font-Size="18px" ForeColor="Navy"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow><asp:TableCell ColumnSpan="2">&nbsp;</asp:TableCell></asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Button ID="cmdSaveTennisGirls" runat="server" Text="Save Changes" ForeColor="Green" Font-Bold="True" /></asp:TableCell>
                <asp:TableCell><asp:Button ID="cmdCancelTennisGirls" Text="DONE" runat="server" CommandName="Cancel" Font-Bold="True"></asp:Button>&nbsp;&nbsp;
