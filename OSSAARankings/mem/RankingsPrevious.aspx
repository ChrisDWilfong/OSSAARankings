<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RankingsPrevious.aspx.vb" Inherits="OSSAARankings.RankingsPrevious"  ClientTarget="uplevel"  %>
...
<head runat="server">
    <title>OSSAARankings.com : Previous Rankings</title>
</head>
<body>
                    ...
                    <asp:Table ID="TableHome" runat="server" Width="100%">
                        ...
                        <asp:TableRow><asp:TableCell>
                            <asp:DropDownList ID="cboAction" runat="server" AutoPostBack="True" Font-Names="Segoe UI, Helvetica, Helvetica Neue, Lucida Grande, Arial, Verdana, Sans-serif;" Width="250px" Font-Bold="true" Font-Size="18px" BackColor="Orange" style="border-style:solid;border-width:1px;">
                                ...
                                <asp:ListItem Value="EnterRankings" Enabled="true">Enter Rankings</asp:ListItem>
                                ...
                                <asp:ListItem Value="RankingsPrevious" Selected="True">Previous Rankings</asp:ListItem>
                            ...
                            <asp:TableCell>
                                <asp:Table runat="server" ID="tblRO1">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell><asp:DropDownList runat="server" ID="cboSelectWeek" CssClass="rankingsDropdown" DataValueField="wID" DataTextField="strDisplay" BackColor="LightGreen" Font-Bold="true"></asp:DropDownList></asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
...
<asp:SqlDataSource runat="server" ID="SQLDataSource1" 
    ...
    SelectCommand="SELECT TOP 20 ID, WeekID, sportID, SportIDOLD, SchoolID, School, RankDate, TeamID, Rank, Points, NumOne, intYear, WL, intWeekNo, prevWeek FROM tblRankings WHERE WeekID = @WeekID ORDER BY Rank">
        <SelectParameters>
...
<asp:SqlDataSource runat="server" ID="SQLDataSource2" 
    ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
    SelectCommand="SELECT ID, WeekID, sportID, SportIDOLD, SchoolID, School, RankDate, TeamID, Rank, Points, NumOne, intYear, WL, intWeekNo, prevWeek FROM tblRankings WHERE WeekID = @WeekID ORDER BY Rank">
        <SelectParameters>
            <asp:ControlParameter ControlID="cboSelectWeek" Name="WeekID" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
