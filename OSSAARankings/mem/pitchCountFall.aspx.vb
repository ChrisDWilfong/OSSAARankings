Public Class pitchCountFall
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        lblHeader.Text = "20" & clsFunctions.GetCurrentYear - 1 & " FALL BASEBALL PITCH COUNT - OSSAARankings.com"
    ...
    Public Function GetPitchCountInfoDetails(teamID As Long) As String
        ...
        strSQL = "SELECT * FROM viewPitchCountFall WHERE teamID = " & teamID & " ORDER BY gameDate DESC, intPitchCount DESC"
        ...
        Else
            For x = 0 To ds.Tables(0).Rows.Count - 1
                With ds.Tables(0).Rows(x)
                    If .Item("strOpponent") & .Item("gameDate") <> strKey Then
                        ...
                        End If
                        If ds.Tables(0).Rows(x).Item("strOpponent") Is System.DBNull.Value Then
                            strKey = .Item("OtherTeam") & .Item("gameDate")
                        Else
                            strKey = .Item("strOpponent") & .Item("gameDate")
                        End If
                    End If
    ...
    Public Function GetPitchCountInfoTotals(teamID As Long) As String
        ...
        strSQL = "SELECT * FROM viewPitchCountFallSUM WHERE teamID = " & teamID & " ORDER BY totalPitches DESC"
        ds = SqlHelper.ExecuteDataset(SqlHelper.SQLConnection, CommandType.Text, strSQL)
