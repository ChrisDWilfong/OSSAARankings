<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PrefEdit6A5A.ascx.vb" Inherits="OSSAARankings.PrefEdit6A5A" %>
...
<table id="editOfficials" width="700px">
    <tr>
        ...
        <td align="right"><asp:Button ID="cmdSave" runat="server" Text="Save Changes" CssClass="button" /></td>
    </tr>
    ...
    <tr style="background-image:url('../images/black_bg.gif'); height:32px;"><td colspan="4"><asp:Label ID="lblHeader" Width="100%" CssClass="shadedheader" ForeColor="White" Font-Bold="true" runat="server" style="text-align:center;" Text="2012 DISTRICT PREFERENTIAL OFFICIALS LIST (STEP 1)"></asp:Label></td></tr>
