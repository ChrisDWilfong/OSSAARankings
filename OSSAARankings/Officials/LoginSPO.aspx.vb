Public Class LoginSPO
    ...
    Protected Sub cmdLogin_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdLogin.Click
        ...
        strInvalidCodeMessage = "Invalid code.  You are not identified as qualifying to enter Playoff Availability in our system (OSSAA enrolled SLOW Pitch official and passed Part 1, Concussion and Heat).  Please email Sheree Riddell (sriddell@ossaa.com) or call 405.840.1116"
