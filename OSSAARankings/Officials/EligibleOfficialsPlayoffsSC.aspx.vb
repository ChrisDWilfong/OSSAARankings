...
Public Class EligibleOfficialsPlayoffsSC
    Inherits System.Web.UI.Page

    ' NEWSEASON (SOCCER) : Change the Date Headings on the Grid...
    ...
    Protected Sub cmdGo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdGo.Click
        ...
        strSQL = "SELECT TOP 1000 * FROM viewOfficialsSoccerEligibleAvailablePlayoffs ORDER BY " & strOrderByClause

        Dim intCount As Integer
        intCount = SqlHelper.ExecuteScalar(SqlHelper.SQLConnectionOSSAA, Data.CommandType.Text, "SELECT Count(*) AS intCount FROM viewOfficialsSoccerEligibleAvailablePlayoffs")
