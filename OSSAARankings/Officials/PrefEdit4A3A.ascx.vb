...
Partial Class PrefEdit4A3A
    ...
    Public Sub DoSave()
        ...
        Else
            ...
            Dim strEmailTo As String = "chris@theSportsEngine.com"
            ...
            strContent = "Submitted By : " & Session("prefCoachName") & "<br>"
            strContent = strContent & Session("userPosition") & " from : " & Session("prefSchoolName") & "<br>"
            strContent = strContent & "Email : " & Session("prefUser") & "<br>"
            strContent = strContent & "Host School : " & Session("DistrictHostSchool") & "<br><br>"
            strContent = strContent & strSQL2 & "<br><br>"
