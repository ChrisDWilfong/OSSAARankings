Public Class LoginPlayoffEBA
    ...
    Public Sub DoLogin(ByVal strEmail As String)
        ...
        strInvalidCodeMessage = "Invalid code.  You are not identified as a Head Baseball Coach or Administrator for a District in our system."
        ...
        Else
            ...
            Dim strSQL As String = "SELECT TOP 1 * FROM viewPlayoffBALogins WHERE Email = '" & strEmailCheck & "'"
            ...
            Else
                ...
                ' Log Activity...
                strSQL = "INSERT INTO tblLogEligibleOfficialsPlayoffs (strEmail, strName, strSchool, strPosition, strSport, intYear) VALUES ('" & Session("user") & "', '" & Session("userName") & "', '" & Session("userSchoolName") & "', '" & ds.Tables(0).Rows(0).Item("Position") & "', 'BAS', 12)"
