<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EligibleOfficialsFootballPlayoffs.ascx.vb" Inherits="OSSAARankings.EligibleOfficialsFootballPlayoffs" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT [OfficialID] AS [Id], [OfficialID] AS [intOSSAAID], [LastName] AS [strLastName], [FirstName] AS [strFirstName], UPPER([LastName]) + ', ' + UPPER([FirstName]) AS [FullName], UPPER([City]) AS [strCity] FROM [viewFootballOfficials] ORDER BY LastName, FirstName">
        <SelectParameters>
