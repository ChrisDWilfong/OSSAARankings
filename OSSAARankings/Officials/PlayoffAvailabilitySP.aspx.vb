Partial Class PlayoffAvailabilitySP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        objDashboard = New clsDashboard("PLAYOFFAVAIL", "SoftballSP", clsFunctions.GetCurrentYear)
        ...
        lblPageHeader.Text = "&nbsp;&nbsp;OFFICIALS " & objDashboard.gYear & " SLOW PITCH PLAYOFF AVAILABILITY"
        lblInstructionsStep1a.Text = "Number of SLOW PITCH High School Dates worked THIS SEASON"
        LoadLabels()
    ...
    Private Sub LoadLabels()
        ...
        lblTuesday.Text = objDashboard.gTourney101
        lblWednesday.Text = objDashboard.gTourney102
    End Sub
...
#Region "Functions"
    ...
    Public Function SaveData(ByVal intOSSAAID As Integer) As String
        ...
        If strReturn = "OK" Then
            ...
            strSQL = strSQL & "strHatSize = '" & Me.cboHatSize.SelectedValue & "', "            ' CDW added 3/28/2017...

            ' Availability...
            strSQL = strSQL & "intPlayoffAvail01 = " & IIf(Me.cbTuesday.Checked = True, 1, 0) & ", "
            strSQL = strSQL & "intPlayoffAvail02 = " & IIf(Me.cbWednesday.Checked = True, 1, 0) & ", "
    ...
    Public Function LoadData(ByVal intOSSAAID As Integer) As String
        ...
        Else
            ...
            With ds.Tables(0).Rows(0)
                ...
                Me.cbTuesday.Checked = IIf(.Item("intPlayoffAvail01") = 1, True, False)
                Me.cbWednesday.Checked = IIf(.Item("intPlayoffAvail02") = 1, True, False)
    ...
    Public Sub CreateRecord(ByVal intOSSAAID As Integer, ByVal strPlayoffCrewName As String)
        ...
        strSQL = "INSERT INTO " & objDashboard.gTableSource & " (intOSSAAID, strSport, intYear) VALUES (" & intOSSAAID & ", 'SBS', " & clsFunctions.GetCurrentYear & ")"
        SqlHelper.ExecuteNonQuery(SqlHelper.SQLConnectionOSSAA, CommandType.Text, strSQL)
    ...
    Public Function VerifyData() As String
        ...
        If Me.intNumberOfYearsExperience.Text = "" Then
            strReturn = "You must select : Number of years as an OSSAA Slow Pitch Umpire."
        ElseIf cboHSGames.SelectedValue = "Select..." Then
            strReturn = "You must select : Number of SLOW PITCH High School Dates worked THIS SEASON."
        ...
        ElseIf Me.intNumberOfStateTournaments.Text = "" Then
            strReturn = "You must select : Number of State Slow Pitch Tournaments worked."
        Else
            strReturn = "OK"
        End If
