<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Wrestling.Master" CodeBehind="EligibleOfficialsPlayoffsWR.aspx.vb" Inherits="OSSAARankings.EligibleOfficialsPlayoffsWR" %>
...
<igtbl:UltraGridBand>
    <Columns>
        ...
        <igtbl:UltraGridColumn BaseColumnName="strPhone1" IsBound="True" Key="strPhone1" Width="110px">
        ...
        <igtbl:UltraGridColumn BaseColumnName="intPlayoffAvail01" IsBound="True" Key="intPlayoffAvail01" Width="20px">
            <Header Caption="DUAL STATE">
        ...
        <igtbl:UltraGridColumn BaseColumnName="intPlayoffAvail02" IsBound="True" Key="intPlayoffAvail02" Width="20px">
            <Header Caption="REGIONALS">
        ...
        <igtbl:UltraGridColumn BaseColumnName="intPlayoffAvail03" IsBound="True" Key="intPlayoffAvail03" Width="20px">
...
<AddNewRow Visible="NotSet" View="NotSet"></AddNewRow>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT TOP 600 * FROM viewOfficialsWrestlingEligibleAvailablePlayoffs ORDER BY strLastName, strFirstName">
    </asp:SqlDataSource>
</asp:Content>
