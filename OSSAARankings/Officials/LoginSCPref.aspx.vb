Public Class LoginSCPref
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        If Now >= ConfigurationManager.AppSettings("SoccerPrefsDateStart") And Now <= ConfigurationManager.AppSettings("SoccerPrefsDateEnd") Then
    ...
    Public Sub DoLogin2()
        ...
        Else
            ...
            Else
                ...
                strSQL = "SELECT * FROM allCoachesDetail WHERE emailMain = '" & strEmail & "' AND intYear = " & clsFunctions.GetCurrentYear & " AND sportID Like 'Soccer%'"
            End If
            ...
            Else
                ...
                If strMessageEmail = "OK" Then
                    ...
                    End If
                    Response.Redirect("PrefEntrySC.aspx?l=" & Request.QueryString("l"))
    ...
    Public Function VerifyEmailToSchool(schoolID As Long, strEmail As String) As String
        ...
        strSQL = "SELECT teamID FROM allCoachesDetail WHERE schoolID = " & schoolID & " AND EmailMain = '" & strEmail & "' AND sportID Like 'Soccer%'"
        Try
