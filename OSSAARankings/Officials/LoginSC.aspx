<%@ Page Title="OSSAA Soccer Officials Login" Language="vb" AutoEventWireup="false" MasterPageFile="Officials.Master" CodeBehind="LoginSC.aspx.vb" Inherits="OSSAARankings.LoginSC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr><td>&nbsp;</td></tr>
        <tr><td><asp:Label ID="lblHeader" runat="server" Text="SOCCER Officials Login for Playoff Availability :" Font-Names="Arial" Font-Bold="true" Font-Size="12pt"></asp:Label></td></tr>
        <tr>
            <td>
