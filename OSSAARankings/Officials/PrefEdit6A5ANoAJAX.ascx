<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PrefEdit6A5ANoAJAX.ascx.vb" Inherits="OSSAARankings.PrefEdit6A5ANoAJAX" %>
...
<table id="editOfficials" width="700px">
    <tr>
        ...
        <td align="right">
            <asp:Button ID="cmdBack" runat="server" Text="Go Back" CssClass="button" /><br /><asp:Label
                ID="Label13" runat="server" Text="&nbsp;&nbsp;" style="font-family:Arial; font-size:10px;"></asp:Label>
        </td>
        <td align="right"><asp:Button ID="cmdSave" runat="server" Text="Save Changes" CssClass="button" BackColor="Green" ForeColor="White" Font-Bold="true" Font-Size="Large" /><br /><asp:Label
                ID="Label3" runat="server" Text="Please wait for your confirmation message..." style="font-family:Arial; font-size:10px;"></asp:Label></td>
    </tr>
    ...
    <tr style="background-image:url('../images/black_bg.gif'); height:32px;"><td colspan="4"><asp:Label ID="lblHeader" Width="100%" CssClass="shadedheader" ForeColor="White" Font-Bold="true" runat="server" style="text-align:center;" Text="BASKETBALL REGIONAL PREFERENTIAL OFFICIALS LIST (STEP 1)"></asp:Label></td></tr>
    ...
    <tr style="background-color:Maroon;" height="30px"><td colspan="4"><asp:Label ID="Label7" Width="100%" CssClass="text" runat="server" style="text-align:center; color:White; font-weight:bold; font-family: Verdana; font-size:10pt;" Text="Select your Top 20 officials in order of preference, below"></asp:Label></td></tr>
    <tr style="background-color:Gray;">
        ...
        <td width="10%" align="center"><asp:Label ID="Label14" runat="server" Text="MILES" CssClass="shadedheader"></asp:Label></td>
    </tr>
    ...
    <tr style="background-color:White;">
        <td width="20%" valign="top"><asp:Label ID="lblNo16" runat="server" Text="&nbsp;16.<span style='color:Red'>*</span>" CssClass="label"></asp:Label>&nbsp;
        ...
        <td width="10%" valign="top" align="center"><i><asp:Label ID="lblOfficialMiles16" runat="server" Text="" CssClass="label" style="text-align:center;"></asp:Label></i></td>
    </tr>
    <tr style="background-color:Silver;">
        <td width="20%" valign="top"><asp:Label ID="lblNo17" runat="server" Text="&nbsp;17.<span style='color:Red'>*</span>" CssClass="label"></asp:Label>&nbsp;
        ...
        <td width="10%" valign="top" align="center"><i><asp:Label ID="lblOfficialMiles17" runat="server" Text="" CssClass="label" style="text-align:center;"></asp:Label></i></td>
    </tr>
    <tr style="background-color:White;">
        <td width="20%" valign="top"><asp:Label ID="lblNo18" runat="server" Text="&nbsp;18.<span style='color:Red'>*</span>" CssClass="label"></asp:Label>&nbsp;
        ...
        <td width="10%" valign="top" align="center"><i><asp:Label ID="lblOfficialMiles18" runat="server" Text="" CssClass="label" style="text-align:center;"></asp:Label></i></td>
    </tr>
    <tr style="background-color:Silver;">
        <td width="20%" valign="top"><asp:Label ID="lblNo19" runat="server" Text="&nbsp;19.<span style='color:Red'>*</span>" CssClass="label"></asp:Label>&nbsp;
        ...
        <td width="10%" valign="top" align="center"><i><asp:Label ID="lblOfficialMiles19" runat="server" Text="" CssClass="label" style="text-align:center;"></asp:Label></i></td>
    </tr>
    <tr style="background-color:White;">
        <td width="20%" valign="top"><asp:Label ID="lblNo20" runat="server" Text="20.<span style='color:Red'>*</span>" CssClass="label"></asp:Label>&nbsp;
        ...
        <td width="10%" valign="top" align="center"><i><asp:Label ID="lblOfficialMiles20" runat="server" Text="" CssClass="label" style="text-align:center;"></asp:Label></i></td>
    </tr>
</table>
