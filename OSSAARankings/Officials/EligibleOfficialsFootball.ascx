<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EligibleOfficialsFootball.ascx.vb" Inherits="OSSAARankings.EligibleOfficialsFootball" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [Id], [intOSSAAID], [strLastName], [strFirstName], [strLastName] + ', ' + [strFirstName] AS [FullName], [strCity], [ysnCurrentFootball] FROM [prodOfficials] WHERE (([ysnCurrentFootball] = -1) And (intTestFootball >= 74) And (intOSSAAID > 0) AND (strState = 'OK')) OR (([ysnCurrentFootball] = -1) And (intOSSAAID > 0) AND (strState <> 'OK')) ORDER BY strLastName">
        <SelectParameters>
