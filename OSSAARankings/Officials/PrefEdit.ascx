<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PrefEdit.ascx.vb" Inherits="OSSAARankings.PrefEdit" %>
...
<table id="ediBrackets" width="750px">
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr style="background-image:url('../images/black_bg.gif'); height:32px;"><td colspan="2"><asp:Label ID="Label22" Width="100%" CssClass="shadedheader" ForeColor="White" Font-Bold="true" runat="server" style="text-align:center;" Text="DISTRICT BRACKETS ENTRY (BOYS AND GIRLS) (STEP 2)"></asp:Label></td></tr>
    <tr style="background-color:Maroon;" height="30px"><td colspan="4"><asp:Label ID="Label24" Width="100%" CssClass="text" runat="server" style="text-align:center; color:White; font-weight:bold; font-family: Verdana; font-size:10pt;" Text="In 3 team districts, the district representatives are to rate and seed two teams on the percentage record of games won and lost, which are to be placed on the top and bottom of the bracket respectively, by record.  The worst record shall choose either seeded team automatically placing the Bye. <br><span style='color:yellow;'>PLEASE PUT THE BYE GAME ON THE TOP OF THE BRACKET WITH THE BYE TEAM AT THE TOP.</span><br><br>All two team district games for Classes 2A, A and B will be played on Saturday night.<br>"></asp:Label></td></tr>
    <tr><td colspan="2" style="background-color:Yellow;"><asp:Label ID="lblMessage2" CssClass="label" runat="server" Text="" style="color:Red; font-weight:bold; font-size:12pt;"></asp:Label></td></tr>
    <tr style="background-color:Navy;" height="26px">
        <td colspan="2"><asp:Label ID="Label14" Width="100%" CssClass="text" runat="server" style="text-align:center; color:White; font-weight:bold; font-family: Verdana; font-size:10pt;" Text="Boys Bracket"></asp:Label></td>
    </tr>
    <tr>
        <td width="160px" style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;">
            <asp:DropDownList ID="cboTeam1" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td style="border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:Label ID="lblGame1" runat="server" Text="BYE" CssClass="label" Font-Italic="True"></asp:Label></td>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;"><asp:DropDownList ID="cboTeam5" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>       
    </tr>
    <tr>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black; border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:DropDownList ID="cboTeam2" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td><asp:Label ID="lblGame3" runat="server" Text="SATURDAY GAME" CssClass="label" 
                Font-Italic="True"></asp:Label></td>
    </tr>
    <tr>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;">
            <asp:DropDownList ID="cboTeam3" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td style="border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:Label ID="lblGame2" runat="server" Text="FRIDAY GAME" CssClass="label" 
                Font-Italic="True"></asp:Label></td>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;"><asp:DropDownList ID="cboTeam6" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>       
    </tr>
    <tr>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black; border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:DropDownList ID="cboTeam4" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr><td colspan="2">&nbsp;</td></tr>
    <tr><td colspan="2" style="background-color:Yellow;"><asp:Label ID="lblMessage3" CssClass="label" runat="server" Text="" style="color:Red; font-weight:bold; font-size:12pt;"></asp:Label></td></tr>
    <tr style="background-color:Navy;" height="26px">
        <td colspan="2"><asp:Label ID="Label15" Width="100%" CssClass="text" runat="server" style="text-align:center; color:White; font-weight:bold; font-family: Verdana; font-size:10pt;" Text="Girls Bracket"></asp:Label></td>
    </tr>
    <tr>
        <td width="160px" style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;">
            <asp:DropDownList ID="cboTeam11" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td style="border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:Label ID="lblGame11" runat="server" Text="BYE" CssClass="label" 
                Font-Italic="True"></asp:Label></td>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;"><asp:DropDownList ID="cboTeam15" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>       
    </tr>
    <tr>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black; border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:DropDownList ID="cboTeam12" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td><asp:Label ID="lblGame13" runat="server" Text="SATURDAY GAME" CssClass="label" 
                Font-Italic="True"></asp:Label></td>
    </tr>
    <tr>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;">
            <asp:DropDownList ID="cboTeam13" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td style="border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:Label ID="lblGame12" runat="server" Text="FRIDAY GAME" CssClass="label" 
                Font-Italic="True"></asp:Label></td>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black;"><asp:DropDownList ID="cboTeam16" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>       
    </tr>
    <tr>
        <td style="border-bottom:3px; border-bottom-style:solid; border-bottom-color: Black; border-right:3px; border-right-style:solid; border-right-color: Black;">
            <asp:DropDownList ID="cboTeam14" runat="server" CssClass="dropdown" Width="150px">
            </asp:DropDownList>
        </td>
        <td>&nbsp;</td>
    </tr>
...
<table id="editSignature" width="750px">
    <tr style="background-image:url('../images/black_bg.gif'); height:32px;"><td colspan="4"><asp:Label ID="Label12" Width="100%" CssClass="shadedheader" ForeColor="White" Font-Bold="true" runat="server" style="text-align:center;" Text="PARTICIPATING DISTRICT SCHOOLS REPRESENTATIVES (STEP 3)"></asp:Label></td></tr>
    ...
    <tr><td colspan="4" style="background-color:Yellow;"><asp:Label ID="lblMessage4" CssClass="label" runat="server" Text="" style="color:Red; font-weight:bold; font-size:12pt;"></asp:Label></td></tr>
    ...
    <tr style="background-image:url('../images/black_bg.gif'); height:32px;"><td colspan="4"><asp:Label ID="Label16" Width="100%" CssClass="shadedheader" ForeColor="White" Font-Bold="true" runat="server" style="text-align:center;" Text="SAVE CHANGES (STEP 4)"></asp:Label></td></tr>
