<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EligibleOfficialsBasketball.ascx.vb" Inherits="OSSAARankings.EligibleOfficialsBasketball" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [Id], [intOSSAAID], [strLastName], [strFirstName], [strLastName] + ', ' + [strFirstName] AS [FullName], [strCity], [ysnCurrentBasketball] FROM [prodOfficials] WHERE (([ysnCurrentBasketball] = -1) And (intTestBasketball >= dbo.GetOfficialsPassingScore()) And (intOSSAAID > 0)) ORDER BY strLastName">
        <SelectParameters>
            <asp:Parameter DefaultValue="100" Name="ysnPrintedBasketball" Type="Int16" />
        </SelectParameters>
</asp:SqlDataSource>
