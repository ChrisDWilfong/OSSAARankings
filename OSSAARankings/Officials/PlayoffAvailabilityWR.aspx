<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Officials.Master" CodeBehind="PlayoffAvailabilityWR.aspx.vb" Inherits="OSSAARankings.PlayoffAvailabilityWR" %>
...
<tr id="PageTitle" style="background-image:url('../images/red_bg.gif'); height:30px;"><td><asp:Label ID="lblPageHeader" runat="server" Text="&nbsp;&nbsp;OFFICIALS WRESTLING PLAYOFF AVAILABILITY" style="font-family:Arial; font-size:16px; font-weight:bold; background-image:url('../images/red_bg.gif'); color:Yellow;"></asp:Label></td></tr>
<tr><td> 
    <table>
        <tr>
...
<tr id="trStep1">
    ...
    <asp:Panel ID="panelStep1Collapsable" runat="server" CssClass="pnlCSS" Width="95%" Height="700px" BorderStyle="None">
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="" CssClass="panelInst">Level of play you worked LAST PLAYOFF SEASON (check all that apply)</asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    &nbsp;&nbsp;<asp:CheckBox CssClass="checkbox" ID="cbLevel2" runat="server" Text="&nbsp;&nbsp;Dual State" />
                </td>
            </tr>
            <tr>
                <td>
                    &nbsp;&nbsp;<asp:CheckBox CssClass="checkbox" ID="cbLevel3" runat="server" Text="&nbsp;&nbsp;Regionals" />
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:Panel ID="panelStep2Collapsable" runat="server" CssClass="pnlCSS" Width="95%" Height="700px" BorderStyle="None">
        <table width="75%" border="0">
            ...
            <tr style="background-color:Silver;">
                <td width="210px">
                    <asp:Label ID="lblWeek1" runat="server" Text="&nbsp;Feb 14 : DUAL STATE : " CssClass="label"></asp:Label>
                </td>
                <td>
                <asp:DropDownList ID="cboSessionDualState" runat="server" CssClass="dropdown">
            ...
            <tr>
                <td width="210px">
                    <asp:Label ID="lblWeek2" runat="server" Text="&nbsp;Feb 20-21 : REGIONALS : " CssClass="label"></asp:Label>
                </td>
                <td>
                <asp:DropDownList ID="cboSessionRegionals" runat="server" CssClass="dropdown">
                    <asp:ListItem Selected="True" Value="0">Not Available</asp:ListItem>
                    <asp:ListItem Value="1">Available</asp:ListItem>
                </asp:DropDownList>
                </td>
            ...
            <tr>
                <td width="210px">
                    <asp:Label ID="lblWeek3" runat="server" Text="&nbsp;Feb 27-28 : STATE : " CssClass="label"></asp:Label>
                </td>
                <td>
                <asp:DropDownList ID="cboSessionState" runat="server" CssClass="dropdown">
                    <asp:ListItem Selected="True" Value="0">Not Available</asp:ListItem>
                    <asp:ListItem Value="1">Available</asp:ListItem>
                </asp:DropDownList>
                </td>
...
<ajax:CollapsiblePanelExtender
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT [schoolID], [strDisplay] AS SchoolName FROM [viewTeamsWrestling] ORDER BY SchoolName">
    </asp:SqlDataSource>  
</asp:Content>
