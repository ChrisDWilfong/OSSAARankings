...
Partial Class ucViewScheduleFBWeek4
    ...
    Public Function InitializeDataSet(ByVal strClass As String) As String
        ...
        sqlAll = clsSchedules.GetScheduleSportDaySQL(sportGenderKey, gClass, "", "WEEK4", 0)
    ...
    Public Sub RefreshHeader()
        ...
        strSport = "Playoffs Week #4 " & Session("gSportDisplay") & " Schedule"
