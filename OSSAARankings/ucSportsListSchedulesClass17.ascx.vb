...
Public Class ucSportsListSchedulesClass17
    Inherits System.Web.UI.UserControl

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        If Not IsPostBack Then
            Dim intYear As Integer = 17
            Dim ds As DataSet
            Dim x As Integer
            ...
            Else
                For x = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    objGroupBar.NavigateUrl = "?sel=schedulesClass17&spGK=" & ds.Tables(0).Rows(x).Item("SportGenderKey") & "&y=" & intYear
                    ExplorerBarSportsListClass17.Groups.Add(objGroupBar)
                Next x
            End If
        End If
    End Sub
