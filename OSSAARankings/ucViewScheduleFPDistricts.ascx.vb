...
Partial Class ucViewScheduleFPDistricts
    ...
    Shared intDistricts As Integer = 32
    ...
    Public Function InitializeDataSet(strSportID As String, intRows As Integer) As String
    ...
    Public Sub RefreshHeader()
        ...
        strSport = Session("gSportDisplay") & " Schedules "
    ...
    Private Function InitializeDataSet(p1 As Integer) As Object
