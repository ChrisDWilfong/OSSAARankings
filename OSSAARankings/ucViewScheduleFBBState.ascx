<%@ Control Language="vb" AutoEventWireup="false" Inherits="OSSAARankings.ucViewScheduleFBBState" Codebehind="ucViewScheduleFBBState.ascx.vb" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<link href="./mem/mem.css" rel="stylesheet" type="text/css" />
<link href="Rankings.css" rel="stylesheet" type="text/css" />
<asp:Table runat="server" style="width:600px;" ID="tblFP101">
   ...
   <asp:TableRow HorizontalAlign="Left">
    ...
    <asp:TableRow><asp:TableCell>
        <asp:Image ID="Image1" runat="server" src="images/sponsors/stateChampionshipSponsor.gif" /><asp:Image ID="Image2" runat="server" src="images/sponsors/fallSponsor.gif" /><asp:Image ID="Image3" runat="server" src="images/sponsors/playoffSponsor.gif" /><asp:Image ID="Image4" runat="server" src="images/sponsors/scoreboardSponsor.gif" />
    </asp:TableCell></asp:TableRow>
</asp:Table>

<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
    SelectCommand="SELECT DISTINCT [Class], [Sort], [sportID] FROM [tblSports] WHERE ([SportGenderKey] = @Sport) AND ([Class] <> '-') AND ([intPlayoffsScheduleShowState] > 0) ORDER BY [Sort]">
    <SelectParameters>
