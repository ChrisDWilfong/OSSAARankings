...
Partial Class ucViewScheduleFBBRegionals
    ...
    Shared intRegionals As Integer = 4
            ...
            For y = 0 To dsHeader.Tables(0).Rows.Count - 1
                If dsHeader.Tables(0).Rows(y).Item("playoffsregional") = (x + 1) Then
                    If dsHeader.Tables(0).Rows(y).Item("ysnHostregional") <> 0 Then
                        'strHeader = strSpanBold & "regional #" & (x + 1) & " @ " & dsHeader.Tables(0).Rows(y).Item("SchoolName") & "</span><br>"
    ...
    Public Sub RefreshHeader()
        ...
        strSport = "Baseball (Fall) Regionals Schedules "
