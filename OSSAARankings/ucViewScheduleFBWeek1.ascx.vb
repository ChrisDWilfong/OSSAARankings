...
Partial Class ucViewScheduleFBWeek1
    ...
    Public Function InitializeDataSet(ByVal strClass As String) As String
        ...
        sqlAll = clsSchedules.GetScheduleSportDaySQL(sportGenderKey, gClass, "", "TOSSAA32", 0)
    ...
    Public Sub RefreshHeader()
        ...
        strSport = "Playoffs Week #1 " & Session("gSportDisplay") & " Schedule"
