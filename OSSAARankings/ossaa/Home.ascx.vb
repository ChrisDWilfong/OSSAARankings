Partial Class Home2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        objControl1 = CType(LoadControl("HomeColumn1Db.ascx"), UserControl)
        PlaceHolder1a.Controls.Add(objControl1)
        Dim objControl2 As New UserControl
        objControl2 = CType(LoadControl("HomeColumn2Db.ascx"), UserControl)
        PlaceHolder2a.Controls.Add(objControl2)
        Dim objControl3 As New UserControl
        objControl3 = CType(LoadControl("HomeColumn3Db.ascx"), UserControl)
