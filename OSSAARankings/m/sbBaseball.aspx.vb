    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Select Case strSportGenderClass
                Case "Baseball6A"
                    strHeader = "CLASS 6A BASEBALL "
                Case "Baseball5A"
                    strHeader = "CLASS 5A BASEBALL "
                Case "Baseball4A"
                    strHeader = "CLASS 4A BASEBALL "
                Case "Baseball3A"
                    strHeader = "CLASS 3A BASEBALL "
                Case "Baseball2A"
                    strHeader = "CLASS 2A BASEBALL "
                Case "BaseballA"
                    strHeader = "CLASS A BASEBALL "
                Case "BaseballB"
                    strHeader = "CLASS B BASEBALL "
                Case Else
                    strHeader = "CLASS 6A BASEBALL"
                    strSportGenderClass = "Baseball6A"
            End Select
