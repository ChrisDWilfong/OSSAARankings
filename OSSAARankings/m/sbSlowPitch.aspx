<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sbSlowPitch.aspx.vb" Inherits="OSSAARankings.sbSlowPitch" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>OSSAARankings.com - Slow Pitch</title>
...
<body>
    ...
    <div>
        <asp:TextBox runat="server" ReadOnly="true" Text="" ID="lblHeader" Font-Names="Lato" Font-Size="24px" ForeColor="Yellow" BackColor="Black" BorderStyle="None" Width="90%" style="padding-left:20px;" ></asp:TextBox><br />
        <asp:TextBox runat="server" ReadOnly="true" Text="" ID="lblHeader1" Font-Names="Lato" Font-Size="12px" ForeColor="Yellow" BackColor="Black" BorderStyle="None" Width="90%" style="padding-left:20px;" >Scores are entered by the Coaches</asp:TextBox>
