Public Class ucSportsListSchedulesClass14
        ...
        If Not IsPostBack Then
            ...
            Else
                For x = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    objGroupBar.NavigateUrl = "?sel=schedulesClass14&spGK=" & ds.Tables(0).Rows(x).Item("SportGenderKey") & "&y=" & intYear
                    ExplorerBarSportsListClass14.Groups.Add(objGroupBar)
                Next x
            End If
