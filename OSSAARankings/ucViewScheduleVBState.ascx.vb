...
Partial Class ucViewScheduleVBState
    ...
    Shared gSportGenderKey As String = "Volleyball"
    Shared gTourneyKey As String = "VolleyballSTATE"
    Shared gSportDisplay As String = "Volleyball"
    ...
    Public Function InitializeDataSet(ByVal strSportID As String, ByVal intRows As Integer) As String
        ...
        strSQL = strSQL & "dbo.tblSports.strPlayoffsScheduleShowState, dbo.tblSchedules.gamedate, dbo.tblSchedules.gametime, "
        ...
        strSQL = strSQL & "ORDER BY tblSchedules.NeutralSiteID, tblSchedules.gameDate, tblSchedules.gameTime"
