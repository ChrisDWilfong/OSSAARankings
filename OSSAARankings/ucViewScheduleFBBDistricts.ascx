<%@ Control Language="vb" AutoEventWireup="false" Inherits="OSSAARankings.ucViewScheduleFBBDistricts" Codebehind="ucViewScheduleFBBDistricts.ascx.vb" %>
...
<asp:Table runat="server" style="width:550px" ID="tblFP101">
   ...
   <asp:TableRow HorizontalAlign="Left">
    ...
    <asp:TableRow><asp:TableCell>
        <asp:Image ID="Image1" runat="server" src="images/sponsors/districtSponsor.gif" /><asp:Image ID="Image2" runat="server" src="images/sponsors/fallSponsor.gif" /><asp:Image ID="Image3" runat="server" src="images/sponsors/playoffSponsor.gif" /><asp:Image ID="Image4" runat="server" src="images/sponsors/scoreboardSponsor.gif" />
    </asp:TableCell></asp:TableRow>
</asp:Table>

<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ConnectionString="<%$ ConnectionStrings:OSSAARANKINGSConnectionString %>" 
    SelectCommand="SELECT DISTINCT [Class], [Sort], [sportID] FROM [tblSports] WHERE ([SportGenderKey] = @Sport) AND ([Class] <> '-') AND ([intPlayoffsScheduleShowDistricts] > 0) ORDER BY [Sort]">
    <SelectParameters>
