...
Public NotInheritable Class SqlHelper
    ...
    Private Shared gdbConnectionOSSAA As String
    Private Shared gdbConnectionOSSAA2019 As String
    Private Shared gdbConnectionOSSAAScoreboard As String
    Private Shared gdbConnectionOSSAAOnline As String
    Private Shared gdbConnectionOSSAASpeech As String
    Private Shared gdbConnectionOSSAAServer As String
    Private Shared gdbConnectionOSSAARankingsArchives As String

    Public Shared Function RedirectToLogin(ByVal strSource As String) As String
        Return "Login.aspx?from=" & strSource
    End Function

    Shared Sub LogUser(ByVal strUserName As String, ByVal strType As String, ByVal intKey As Integer, ByVal strOrganizationType As String, ByVal strSchoolName As String)
        Dim strSQL As String

        If strSchoolName = "" Then
            strSQL = "INSERT INTO tblSchoolLog (Username, OrganizationType, SchoolId, strType) VALUES ("
        Else
            strSQL = "INSERT INTO tblSchoolLog (Username, OrganizationType, SchoolId, SchoolName, strType) VALUES ("
        End If
...
#Region "Servers"
    ...
    Public Shared ReadOnly Property SQLConnection() As String
        Get
            If gdbConnection = "" Then
                If 1 = 2 Then
                    ' DEMO BUILD...
                    gdbConnection = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAARANKINGSConnectionStringDEBUG").ToString
                Else
                    ' LIVE BUILD...
                    gdbConnection = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAARANKINGSConnectionString").ToString
                End If
            End If
    ...
    Public Shared ReadOnly Property SQLConnectionOSSAARankingsArchives() As String
        Get
            If gdbConnectionOSSAARankingsArchives = "" Then
                gdbConnectionOSSAARankingsArchives = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAARANKINGSConnectionStringArchives").ToString
            End If
            Return gdbConnectionOSSAARankingsArchives
        End Get
    End Property

    Public Shared ReadOnly Property SQLConnectionOSSAA() As String
        Get
            If gdbConnectionOSSAA = "" Then
                gdbConnectionOSSAA = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAAConnectionString").ToString
            End If
            Return gdbConnectionOSSAA
        End Get
    End Property

    ' CDW added 6/20/2019...
    Public Shared ReadOnly Property SQLConnectionOSSAA2019() As String
        Get
            If gdbConnectionOSSAA2019 = "" Then
                gdbConnectionOSSAA2019 = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAAConnectionString2019").ToString
            End If
            Return gdbConnectionOSSAA2019
        End Get
    End Property

    Public Shared ReadOnly Property SQLConnectionOSSAAServer() As String

        Get
            If gdbConnectionOSSAAServer = "" Then
                gdbConnectionOSSAAServer = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAAServerConnectionString").ToString
            End If
            Return gdbConnectionOSSAAServer
        End Get

    End Property


    Public Shared ReadOnly Property SQLConnectionOSSAAScoreboard() As String
        Get
            If gdbConnectionOSSAAScoreboard = "" Then
                gdbConnectionOSSAAScoreboard = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAAScoreboardString").ToString
            End If
            Return gdbConnectionOSSAAScoreboard
        End Get
    End Property

    Public Shared ReadOnly Property SQLConnectionOSSAAOnline() As String
        Get
            If gdbConnectionOSSAAOnline = "" Then
                gdbConnectionOSSAAOnline = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAAOnlineConnectionString").ToString
            End If
            Return gdbConnectionOSSAAOnline
        End Get
    End Property
    Public Shared ReadOnly Property SQLConnectionOSSAASpeech() As String
        Get
            If gdbConnectionOSSAASpeech = "" Then
                gdbConnectionOSSAASpeech = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAAConnectionStringSpeech").ToString
            End If
            Return gdbConnectionOSSAASpeech
        End Get
    End Property
