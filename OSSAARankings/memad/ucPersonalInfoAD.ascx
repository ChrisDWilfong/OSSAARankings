<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucPersonalInfoAD.ascx.vb" Inherits="OSSAARankings.ucPersonalInfoAD" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                <asp:Label ID="lblEmailMain" runat="server" CssClass="perInfoLabel">EMAIL (MAIN)<span style="color:Red;"> *</span></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                ...
                <asp:Label ID="lblPhoneAlt" runat="server" CssClass="perInfoLabel">PHONE (SCHOOL)</asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
